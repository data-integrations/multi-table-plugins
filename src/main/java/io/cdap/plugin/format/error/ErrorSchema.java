...
public class ErrorSchema {
  ...
  public static final Schema getSchema() {
    return Schema.recordOf(
      SCHEMA_NAME,
      Schema.Field.of(REFERENCE_NAME, Schema.of(Schema.Type.STRING)),
  ...
  public static RecordWrapper errorRecordWrapper(String referenceName,
                                                 String errorMessage,
                                                 String exceptionClassName,
                                                 @Nullable String tableName) {
    StructuredRecord.Builder builder = StructuredRecord.builder(ErrorSchema.getSchema());
    builder.set(ErrorSchema.REFERENCE_NAME, referenceName);
